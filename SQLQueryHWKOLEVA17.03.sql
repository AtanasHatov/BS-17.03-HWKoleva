...
[Title] NVARCHAR(100),
[LibraryId] INT FOREIGN KEY REFERENCES [Librarries]([LibraryId]) ON DELETE SET DEFAULT
);
...
INSERT INTO Books (Title, LibraryId)
SELECT N'Война и мир', LibraryId FROM Librarries WHERE Name = N'Университетска библиотека'

DELETE FROM Librarries WHERE LibraryId = 3
